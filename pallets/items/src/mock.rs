...
impl orml_nft::Config for Runtime {
	type ClassId = u64;
	type TokenId = u64;
	type ClassData = ItemClassData<AccountId, BlockNumber>;
	type TokenData = ItemTokenData<AccountId, BlockNumber>;
...
construct_runtime!(
		...
		UncheckedExtrinsic = UncheckedExtrinsic,
	{
		...
		NonFungibleTokenModule: orml_nft::{Pallet, Storage, Config<T>},
...
pub const CLASS_ID_NOT_EXIST: <Runtime as orml_nft::Config>::ClassId = 100;
